...
<script language="javascript">	
	...
	function formatText(frmt){
		if (document.bacheca.testo.caretPos && document.bacheca.testo.createTextRange){
			document.bacheca.testo.caretPos.text = '[' + frmt + '][/' + frmt + ']';
		}else{
			document.bacheca.testo.value += '[' + frmt + '][/' + frmt + ']';
		}
		
		document.bacheca.testo.focus();
	}			
</script>
...
<div align="center">
	<table border="0" cellpadding="0" cellspacing="3">	
		<tr>
			...
			<td colspan="2">
				<form action="gest_bacheca_mod_submit.php" name="bacheca" method="post" onSubmit="return check()">
		...
		<tr>
			<td colspan="3" class="small" align="center">
				<a href="gest_bacheca.php" class="plain_e">Indice</a>
			</td>
		</tr>
	</table>
</div>
