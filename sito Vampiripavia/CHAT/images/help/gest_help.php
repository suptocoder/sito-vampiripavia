<?
	...
	//COMBO CAPITOLI
	$sql_combo_capitoli = "SELECT * FROM help_capitoli";
	...
	$sql .= "FROM help_argomenti argomenti RIGHT JOIN help_capitoli capitoli ";
...
<script language="javascript">
	function del_arg(id){	
		...
		if (res){			
			window.location = "gest_help_del_arg.php?id=" + id;
		}
	}
	...
	function del_cap(id){	
		...
		if (res){			
			window.location = "gest_help_del_cap.php?id=" + id;
		}
	}
	
	function sort(id){
		window.open("gest_help_sort.php?id=" + id,"sort","left=200,top=80,width=400,height=150,toolbar=no,statusbar=no,scrollbars=no");
	}
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <? if ($result['id'] != ""){ ?>
    <form name="move" method="post" action="gest_help_movearg.php">
    <tr>
    	<td width="100%">
    		<table border="0" cellpadding="0" cellspacing="1" width="100%">
    			<tr>
			        ...
			        <td class="medium" width="100%" bgcolor="<?=$bgcolor?>">
			            <a href="gest_help_mod.php?id=<?=$result['id']?>" class="plain_e"><?=$result['titolo']?></a><br>            
			        </td>
	...
	<tr>
		<td colspan="4">
			...
			<table border="0" cellpadding="1" cellspacing="0">
				<tr>
					<form action="gest_help_add_capitolo.php" method="post" name="add_capitolo" onSubmit="return check_capitoli()">
				...
				<tr>
					<form action="gest_help_add_arg.php" method="post" name="add_arg">
